...
target/appassembler/bin/SearchCollection \
  -index indexes/lucene-index.beir-v1.0.0-cqadupstack-stats-flat-wp/ \
  -topics tools\topics-and-qrels\topics.beir-v1.0.0-cqadupstack-stats.test.wp.tsv.gz \
...
```
target/appassembler/bin/trec_eval -c -m ndcg_cut.10 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-stats.test.txt runs/run.beir-v1.0.0-cqadupstack-stats-flat-wp.bm25.topics.beir-v1.0.0-cqadupstack-stats.test.wp.txt
target/appassembler/bin/trec_eval -c -m recall.100 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-stats.test.txt runs/run.beir-v1.0.0-cqadupstack-stats-flat-wp.bm25.topics.beir-v1.0.0-cqadupstack-stats.test.wp.txt
target/appassembler/bin/trec_eval -c -m recall.1000 tools\topics-and-qrels\qrels.beir-v1.0.0-cqadupstack-stats.test.txt runs/run.beir-v1.0.0-cqadupstack-stats-flat-wp.bm25.topics.beir-v1.0.0-cqadupstack-stats.test.wp.txt
```

...
```
target/appassembler/bin/trec_eval -c -m map tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-default.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -M 100 -m recip_rank tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-default.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -m recall.100 tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-default.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -m recall.1000 tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-default.topics.msmarco-doc.dev.txt

target/appassembler/bin/trec_eval -c -m map tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-tuned.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -M 100 -m recip_rank tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-tuned.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -m recall.100 tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-tuned.topics.msmarco-doc.dev.txt
target/appassembler/bin/trec_eval -c -m recall.1000 tools\topics-and-qrels\qrels.msmarco-doc.dev.txt runs/run.msmarco-doc-segmented-docTTTTTquery.bm25-tuned.topics.msmarco-doc.dev.txt
```

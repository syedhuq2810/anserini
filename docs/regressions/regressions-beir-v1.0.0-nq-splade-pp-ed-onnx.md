...
target/appassembler/bin/SearchCollection \
  ...
  -output runs/run.beir-v1.0.0-nq-splade-pp-ed.splade-pp-ed.topics.beir-v1.0.0-nq.test.txt \
...
```
target/appassembler/bin/trec_eval -c -m ndcg_cut.10 tools\topics-and-qrels\qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0-nq-splade-pp-ed.splade-pp-ed.topics.beir-v1.0.0-nq.test.txt
target/appassembler/bin/trec_eval -c -m recall.100 tools\topics-and-qrels\qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0-nq-splade-pp-ed.splade-pp-ed.topics.beir-v1.0.0-nq.test.txt
target/appassembler/bin/trec_eval -c -m recall.1000 tools\topics-and-qrels\qrels.beir-v1.0.0-nq.test.txt runs/run.beir-v1.0.0-nq-splade-pp-ed.splade-pp-ed.topics.beir-v1.0.0-nq.test.txt
```
